...
class BigDataTech extends StatefulWidget {
  const BigDataTech({Key? key}) : super(key: key);

  @override
  _BigDataTechState createState() => _BigDataTechState();
}

class _BigDataTechState extends State<BigDataTech> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: DefaultTabController(
          ...
          child: Scaffold(
            appBar: AppBar(
              title: Text('Big Data Technologies'),
              centerTitle: true,
              bottom: TabBar(tabs: [
                Tab(text: "MSE"),
                Tab(text: "SEE"),
