...
class SoftPM extends StatefulWidget {
  const SoftPM({Key? key}) : super(key: key);

  @override
  _SoftPMState createState() => _SoftPMState();
}

class _SoftPMState extends State<SoftPM> {
  @override
    ...
    return MaterialApp(
        ...
        home: DefaultTabController(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              title: Text('Software Project Management'),
              centerTitle: true,
              bottom: TabBar(tabs: [
                Tab(text: "MSE"),
                Tab(text: "SEE"),
